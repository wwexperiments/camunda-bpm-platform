...
public class PlatformTelemetryRegistry {
  ...
  public static synchronized void setApplicationServer(ApplicationServer applicationServer) {
    PlatformTelemetryRegistry.applicationServer = applicationServer;
  }

  public static synchronized void setApplicationServer(String applicationServerVersion) {
    PlatformTelemetryRegistry.applicationServer = new ApplicationServer(applicationServerVersion);
  }
